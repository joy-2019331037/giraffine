...
const TutorialsPage = () => {
  ...
  return (
    <div style={{ maxWidth: "1200px", padding: "16px", margin: "0 auto" }}>
      <h1
        style={{ fontSize: "2rem", marginBottom: "16px", textAlign: "center" }}
      >
        HTML & CSS Tutorials
      </h1>
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          {/* HTML Tutorials */}
          {htmlSelected &&
            htmlTutorials.map((tutorial, index) => (
              <div
                key={index}
                ...
                style={{
                  ...
                  marginBottom: "8px",
                  backgroundColor:
                    selectedHtmlTutorial === index ? "#f0f8ff" : "#fff",
                  cursor: "pointer",
                }}
              >
          ...
          {/* CSS Tutorials */}
          {!htmlSelected &&
            cssTutorials.map((tutorial, index) => (
              <div
                key={index}
                ...
                style={{
                  ...
                  marginBottom: "8px",
                  backgroundColor:
                    selectedCssTutorial === index ? "#f0f8ff" : "#fff",
                  cursor: "pointer",
                }}
              >
                <p style={{ color: "#2c7a7b", fontWeight: "bold", margin: 0 }}>
        ...
        <div style={{ flex: 3 }}>
          {htmlSelected && selectedHtmlTutorial !== null && (
            ...
            >
              ...
              {console.log(htmlTutorials[selectedHtmlTutorial]?.content)}
              <p>{htmlTutorials[selectedHtmlTutorial].description}</p>
              <hr style={{ margin: "16px 0" }} />
              <div
                dangerouslySetInnerHTML={{
                  __html: htmlTutorials[selectedHtmlTutorial]?.content.trim(),
                }}
              />
              <hr style={{ margin: "16px 0" }} />
              <p
          ...
          {!htmlSelected && selectedCssTutorial !== null && (
            ...
            >
              ...
              <div
                dangerouslySetInnerHTML={{
                  __html: cssTutorials[selectedCssTutorial].content,
                }}
              />
              <p
                style={{
